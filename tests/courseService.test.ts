...
// 	{ id: "1", title: "Course 1", description: "Description 1", moduleIds: [] },
// 	{ id: "2", title: "Course 2", description: "Description 2", moduleIds: [] },
// ];
...
// 		const newCourse = await createCourse("New Course", "New Description");
